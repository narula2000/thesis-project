...
line=`cat /home/vm/database-data/history.csv | wc -l`
echo $line
...
psql -U postgres <<-EOSQL
    ...
    COPY WAREHOUSE FROM '/home/vm/database-data/warehouse.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY DISTRICT FROM '/home/vm/database-data/district.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ITEM FROM '/home/vm/database-data/item.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY CUSTOMER FROM '/home/vm/database-data/customer.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY HISTORY FROM '/home/vm/database-data/history.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY STOCK FROM '/home/vm/database-data/stock.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ORDERS FROM '/home/vm/database-data/order.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY NEW_ORDER FROM '/home/vm/database-data/new_order.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ORDER_LINE FROM '/home/vm/database-data/order_line.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");

    CREATE SEQUENCE H_ID_SEQ OWNED BY HISTORY.H_ID;
    SELECT SETVAL('H_ID_SEQ', ${line});
    ALTER TABLE HISTORY ALTER COLUMN H_ID SET DEFAULT nextval('H_ID_SEQ');
EOSQL
