...
psql -U postgres <<-EOSQL
    ...
    COPY WAREHOUSE FROM '/warehouse.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY DISTRICT FROM '/district.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ITEM FROM '/item.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY CUSTOMER FROM '/customer.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY HISTORY FROM '/history.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY STOCK FROM '/stock.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ORDERS FROM '/order.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY NEW_ORDER FROM '/new_order.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
    COPY ORDER_LINE FROM '/order_line.csv' WITH (FORMAT CSV,  DELIMITER ',', NULL "NULL");
