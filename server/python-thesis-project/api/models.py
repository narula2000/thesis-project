...
class Customer(models.Model):
    ...
    class Meta:
        db_table = 'customer'
        unique_together = (('c_w_id', 'c_d', 'c_id'),
                           ('c_w_id', 'c_d', 'c_last', 'c_first'),)

    def __str__(self) -> str:
        return f'Customer -> c_id: {self.c_id}, c_d_id: {self.c_d.d_id}, c_w_id: {self.c_w_id}'


class District(models.Model):
    d_id = models.SmallIntegerField()
    d_w = models.OneToOneField(
        'Warehouse', models.DO_NOTHING, primary_key=True)
    ...
    def __str__(self) -> str:
        return f'District -> d_id: {self.d_id}, d_w_id: {self.d_w.w_id}, d_next_o_id: {self.d_next_o_id}'
...
class NewOrder(models.Model):
    ...
    def __str__(self) -> str:
        return f'New Order -> no_o_id: {self.no_o.o_id}, no_d_id: {self.no_d_id}, no_w_id: {self.no_w_id}'
...
class OrderLine(models.Model):
    ...
    def __str__(self) -> str:
        return f'Order Line -> ol_o_id: {self.ol_o.o_id}, ol_d_id: {self.ol_d_id}, ol_w_id: {self.ol_w_id}, ol_quantity: {self.ol_quantity}'
...
class Orders(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('o_w_id', 'o_d_id', 'o_id'),
                           ('o_w_id', 'o_d_id', 'o_c', 'o_id'),)

    def __str__(self) -> str:
        return f'Order -> o_id: {self.o_id}, o_d_id: {self.o_d_id}, o_w_id: {self.o_w_id}'

class Stock(models.Model):
    s_i = models.ForeignKey(Item, models.DO_NOTHING)
    s_w = models.OneToOneField(
        'Warehouse', models.DO_NOTHING, primary_key=True)
